...
public class CustomVerifyDocumentLibrary extends com.liferay.portal.verify.VerifyDocumentLibrary {
	...
	// Custom LPS-37869 checkMimeTypes
	/*
	@Override	
	...
	*/
	...
	protected void removeEmptyDLFileEntries() throws Exception {
		...
		for (String mimeType : mimeTypes) {
			removeEmptyDLFileEntries(mimeType);
		}
	}
     ...
     * @see https://issues.liferay.com/browse/LPS-37869
	 */
	protected void removeEmptyDLFileEntries(final String mimeType) throws Exception {
		
		List<DLFileEntry> dlFileEntries = DLFileEntryUtil.findByMimeType(mimeType);

		if (_log.isDebugEnabled()) {
			_log.debug(
				"Scanning " + dlFileEntries.size() + " file entries with " +
						mimeType + " MIME type for empty entries");
		}
